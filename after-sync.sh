rm -rf art packages/apps/Settings vendor/lineage vendor/google/gms vendor/google/pixel frameworks/base vendor/gapps packages/apps/Settings frameworks/base vendor/nothing* device/nothing* kernel/nothing* packages/apps/Glyph frameworks/native 
...
git clone https://github.com/xenxynon/manifestt -b lineage-19.1 art
