rm -rf art packages/apps/Settings vendor/lineage vendor/google/gms vendor/google/pixel frameworks/base packages/apps/Settings frameworks/base vendor/nothing* device/nothing* kernel/nothing* packages/apps/Glyph frameworks/native out/target/product/Spacewar/*zip
...
git clone https://github.com/PixysOS-Devices/kernel_nothing_sm7325 kernel/nothing/sm7325 --depth 1
git clone https://gitlab.com/PixysOS/vendor_nothing_camera -b fourteen vendor/nothing/camera --depth 1
git clone https://github.com/PixysOS-Devices/vendor_nothing_Spacewar vendor/nothing/Spacewar --depth 1
git clone https://github.com/Los-Ext/android_packages_apps_Settings -b test packages/apps/Settings --depth 1
...
git clone https://github.com/crdroidandroid/android_art art
